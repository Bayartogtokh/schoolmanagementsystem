...
Оюутны ID:  <input type='text' value='$stid' name='stdid' readonly /> <br />
Курс ID:  <input type='text' value='$crsid' name='crid' readonly /> <br />
Дүн:  <input type='text' name='grade' /> <br />
<input class='menulista' type='submit' value='Батлах' name='sbmt' />
";
echo $string;
}
