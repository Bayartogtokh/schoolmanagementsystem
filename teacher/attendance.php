				...
				<ul>
				    <li class="manulista" align="center">
						    <a class ="menulista" href="index.php">Нүүр хуудас</a>
								...
								<a class ="menulista" href="viewAttendance.php">Ирц харах</a>
								<a class ="menulista" href="viewAttendancest.php">Оюутны ирц</a>
...
<input class="menulista" type ="submit" value="Ирц үүсгэх" name="update"/>
