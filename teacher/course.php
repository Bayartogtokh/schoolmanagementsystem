...
Хичээл сонгох<select id="mycourse" onchange="ajaxRequestToGetCourseStudent();" name="mycourse">
...
<input class="menulista" type ="submit" value="Дүн оруулах" name="submit"/>
<input class="menulista" type ="submit" value="Өөрчлөх" name="update"/>
