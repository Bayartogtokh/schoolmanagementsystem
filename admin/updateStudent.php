        ...
        <center>
            <table>
                <tr>
                    ...
                    <td><input type="text" name="searchId" placeholder="Хайх нэрээ бичнэ үү:" onkeyup="getStudentForUpdate(this.value);"></td>
                </tr>
            </table>
        </center>
        <br/>
        <center>
          <h2>Ганцхан оюутанд хандана.</h2>
...
if(!empty($_POST['submit'])){
    ...
    $sql = "UPDATE students SET id='$stuId', name='$stuName', password='$stuPassword', phone='$stuPhone', email='$stuEmail', sex='$stugender', dob='$stuDOB', addmissiondate='$stuAddmissionDate', address='$stuAddress', classid='$stuClassId' WHERE id='$stuId'";
